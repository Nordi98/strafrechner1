...
def index():
    ...
    # Zähle, wie viele Delikt-Felder übergeben wurden
    delikt_keys = [key for key in request.form.keys() if key.startswith("geld_min_")]
    anzahl_straftaten = len(delikt_keys)
